...
| G5 | 언어 정책 (한글 산문 / 영어 용어) | PASS | 손으로 쓴 파일 146개 스캔 — 정책 밖 문자 0개 (ASCII 503804자 / 한글 67496자). 산문 한글 / 용어·식별자·문서 fixture 영어. 손으로 쓴 파일 전수를 스캔해 ASCII·한글·명시 허용 기호 밖의 문자가 0인지 기계적으로 확인한다 (gr-lang: Korean/English only). |
